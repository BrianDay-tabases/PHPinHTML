...
<div id="content">
    ...
    <form action="." method="post">
        ...
        <select name="number_to_roll">
            ...
            <?php for ($dice = 1; $dice <= 6; $dice++)  :;?>
            <!-- I cant put two for loops in a single option value
                 line, therefore I must split the PHP code into 2 parts. -->
            <option value = "<?php echo $dice; ?>"<?php echo $dice; ?></option>
            <!-- dropdown wont work. check book about closing ?PHP for loops-->
            <!-- to make dropdown work. add a PHP line to endfor -->
            <?php  endfor; /*you need this because for is inside PHP!!*/ ?>
        </select><br />
